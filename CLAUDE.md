...
### コンテキスト管理の原則
**EDITHは詳細を知らなくていい**
- ✅ EDITHは「目的」と「誰に頼むか」だけ知っていればいい
- ✅ 細かい仕様は部門長が把握
- ✅ 技術的詳細は実働部隊が把握
- ❌ EDITHが全ファイルを読み込む必要はない
- ❌ EDITHが実装詳細を理解する必要はない

**例：ブログ作成の場合**
- EDITH: 「ブログ部門長、AI活用記事を1本」← これだけでOK
- 部門長: CONTENT_MARKETING_SPECIFICATIONS.mdを確認して詳細を把握
- 実働部隊: writing_guidelines.mdやSEO設定を確認して実行
